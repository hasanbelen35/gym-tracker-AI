...
import { PortalDataRegister } from '@/types/types';

const PORTALS: PortalDataRegister[] = [
  {
    icon: "🏛️",
    eyebrow: "Salon Kaydı",
    title: "Spor Salonu Kayıt",
    description: "Salonunuzu sisteme kaydedin, üyelerinizi yönetin.",
    label: "Gym Portal",
    path: "/register/gym",
  },
  {
    icon: "🥇",
    eyebrow: "Antrenör Kaydı",
    title: "Antrenör Kayıt",
    description: "Sporcularını yönet, programlarını oluştur ve takip et.",
  ...
  },
  {
    ...
    eyebrow: "Üye Kaydı",
    title: "Sporcu Kayıt",
    description: "Antrenman geçmişini takip et, QR ile giriş yap.",
