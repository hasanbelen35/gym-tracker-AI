    ...
    <main className="flex h-screen overflow-hidden" style={{ fontFamily: "'DM Sans', sans-serif" }}>
      ...
      >
        ...
        <p className="text-sm text-[#7A7A9A] text-center max-w-[200px] leading-relaxed">
          Salon yöneticileri ve personel için özel giriş paneli.
        </p>
      ...
      <div className="relative z-10 pointer-events-none">
        <div className="absolute left-1/2 top-[22%] -translate-x-1/2 w-px h-[55%] bg-gradient-to-b from-transparent via-[#CCC] to-transparent" />
        <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-9 h-9 rounded-full bg-white border border-[#DDD] flex items-center justify-center text-[11px] text-[#999]">
          ya
        </div>
      </div>
      ...
      >
        ...
        <p className="text-sm text-[#4A7A5E] text-center max-w-[200px] leading-relaxed">
          Antrenman geçmişin ve QR kodunla hızlı giriş yap.
        </p>
